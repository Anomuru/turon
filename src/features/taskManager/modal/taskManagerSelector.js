export const getTaskManagerLoading = (state) => state.taskManagerSlice?.loading
export const getTaskManagerLoadingTasks = (state) => state.taskManagerSlice?.loadingTasks
export const getTaskManager = (state) => state.taskManagerSlice?.data
export const getTaskManagerPercentage = (state) => state.taskManagerSlice?.percentage
