...
const todoistSlice = createSlice({
   ...
   initialState,
   reducers: {
      taskLoading: (state) => { state.taskLoading = true },
      taskProfileLoading: (state) => { state.profileLoading = true },
      taskTagsLoading: (state) => { state.tagLoading = true },
      taskLoadingStop: (state) => { state.taskLoading = false },
      taskProfileLoadingStop: (state) => { state.profileLoading = false },
      taskTagsLoadingStop: (state) => { state.tagLoading = false },
