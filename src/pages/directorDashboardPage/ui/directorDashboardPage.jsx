...
import { useDirectorDashboard, MONTHS, RATING_CATEGORIES } from 'features/directorDashboard/index.js';
...
const PieChart = ({ data, size = 140 }) => {
    ...
    return (
        <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
            ...
            <text x={cx} y={cy - 6} textAnchor="middle" fill="#0f172a" fontSize="18" fontWeight="800" fontFamily="Inter">
                {total}
            </text>
        ...
        <div className={cls.dynamicsChart}>
            <div className={cls.dynamicsSummary}>
                ...
                <div className={cls.dynamicsStat}>
                    ...
                    <span className={cls.dynamicsStatValue} style={{ color: totalJoined - totalLeft >= 0 ? '#10b981' : '#ef4444' }}>
                                        ...
                                        {leftData.map((d, i) => {
                                            ...
                                            return (
                                                <div key={i} className={cls.pieLabel}>
                                                    ...
                                                    />
                                                    <span className={cls.pieLabelText}>{d.reason || d.label || `Sabab ${i + 1}`}</span>
