...
const initialState = {
    ...
    error: null,
    employerSalary: [],
    employerSalaryCount: 0,
    deletedEmployerSalary: [],
    deletedEmployerSalaryCount: 0,
}
    ...
    extraReducers: builder =>
        builder
            ...
            .addCase(getEmpSalary.fulfilled, (state, action) => {
                state.employerSalary = action.payload?.results
                state.employerSalaryCount = action.payload?.count
                state.loading = false
                state.error = false
            })
            ...
            .addCase(getDeletedEmpSalary.fulfilled, (state, action) => {
                ...
                state.deletedEmployerSalaryCount = action.payload?.count
                state.loading = false
                state.error = false
            })
